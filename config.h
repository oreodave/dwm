...
static const int topbar             = false;        /* 0 means bottom bar */
...
static const char col_green[]       = "#0e3f05";
static const char col_green2[]      = "#17fc02";
static const char col_red[]         = "#910d01";
static const char *colors[][3]      = {
	/* Scheme            fg         bg         border   */
	[SchemeNorm]     = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]      = { col_gray4, col_cyan,  col_green  },
	[SchemeStatus]   = { col_green2, "#222222",  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
	[SchemeTagsSel]  = { col_green2, col_black,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
